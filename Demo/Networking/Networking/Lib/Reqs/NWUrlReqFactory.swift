...
class NWUrlReqFactory: NSObject {
    ...
    ///
    /// - returns: URLRequest
    class func createReq(reqName:String,paramsValue:[Any]) throws -> URLRequest{
        return try self.createReq(reqName: reqName, paramsValue: paramsValue, header: nil)
    }
    ...
    ///
    /// - returns: URLRequest
    class func createReq(reqName:String,paramsValue:[Any],header:[String:String]?) throws -> URLRequest{
    ...
    ///
    /// - returns: URLRequest
    class func createReq(reqName:String,params:[String:Any]) throws -> URLRequest{
        return try self.createReq(reqName: reqName, params: params, header: nil)
    }
    ...
    ///
    /// - returns: URLRequest
    class func createReq(reqName:String,params:[String:Any],header:[String:String]?) throws -> URLRequest{
        var req = try self.create(reqName: reqName)
        self.setHeader(header: header, req: &req)
    ...
    ///
    /// - returns: URLRequest
    class func createUploadReq(reqName:String) throws -> URLRequest{
        return try self.createUploadReq(reqName: reqName, header: nil)
    }
    ...
    ///
    /// - returns: URLRequest
    class func createUploadReq(reqName:String,header:[String:String]?) throws -> URLRequest{
        var req = try self.create(reqName: reqName)
        self.setHeader(header: header, req: &req)
        return req
    }
